...
class TestDecoder(unittest.TestCase):
    ...
    def test_decoder_layer(self):
        ...
        tgt = tf.random.uniform(shape=[8, 16])
        ...
        tf_decoder_layer.forward(tgt=tgt, memory=memory, tgt_mask=tgt_mask, memory_mask=memory_mask, tgt_key_padding_mask=tgt_key_padding_mask, memory_key_padding_mask=memory_key_padding_mask, training=True)
